        ...
        <div className="container my-5">
            <form>
                <div className="form-group">
                    <label>Name</label>
                    <input type="text" className="form-control" onChange={v => setName(v.target.value)} placeholder="Enter name" />
                </div>
                <br />
                <div className="form-group">
                    <label>Telephone</label>
                    <input type="tel" className="form-control" onChange={v => setTelephone(v.target.value)} placeholder="Enter telephone" />
                </div>
                <br />
                <div className="form-group">
                ...
                <br />
                <button type="button" disabled={!name || !telephone || !email || !password} className="btn btn-primary form-control" onClick={sendRegister}>Submit</button>
            </form>
        </div>
        </>
    )
